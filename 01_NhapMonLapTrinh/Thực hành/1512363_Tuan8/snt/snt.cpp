...
{
	const int MAX = 10;
	int A[MAX] = { 1,11,3,16,5,14,7,91,9,0 };
...
menu:
	...
	case 3: KT_TinhChatSong(A, n); break;
	case 4: KT_SNT_Trong_Mang(A, n, SoSNT); break;
	case 5: if (SoSNT > 0)  Xoa_SNT(A, n); else printf("\n Mang ban nhap khong co SNT de xoa! "); break;
	case 6: AmDuong(A, n); break;
	case 7: Xep_Chan_Le(A, n, vitricl); break;
	case 8: Chen(A, n, vitricl); break;
